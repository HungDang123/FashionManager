        ...
        try {
            ...
            if (dao.selectByID(sp.getMaSanPham()) == null) {
                ...
                try {
                    ...
                    System.out.println("Insert kichThuoc :"+e.getMessage());
                }
            } else {
                dao.update(sp);
...
//            btnLuu1.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(228, 225, 214));
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        try {
            JFileChooser jf = new JFileChooser("image\\");
            ...
            System.out.println( e.getMessage()+"UpLoad");
